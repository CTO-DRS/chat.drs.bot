...
// Heavy editors (CodeMirror, ProseMirror, react-data-grid) are lazy-loaded
// to keep the initial dev/production module graph small.
...
const DocumentContent = ({ document }: { document: Document }) => {
  ...
  return (
    <div className={cn(containerClassName, "relative")}>
      ...
      {document.kind === "code" && (
        <div className="pointer-events-none absolute inset-y-0 end-0 w-12 bg-gradient-to-l from-muted to-transparent dark:from-muted" />
      )}
    </div>
  );
};
