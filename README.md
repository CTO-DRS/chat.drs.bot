...
- 📎 **مرفقات ذكية** — رفع الصور (لنماذج الرؤية) ومستندات PDF و DOCX و TXT و Markdown مع استخراج النص تلقائياً ليقرأه أي نموذج، ودعم كامل لأسماء الملفات العربية
...
- 🌙 **وضع ليلي تلقائي** — قائمة مظهر بخيارات فاتح/داكن/حسب النظام، مع تتبع فوري لتفضيلات نظام التشغيل دون إعادة تحميل
